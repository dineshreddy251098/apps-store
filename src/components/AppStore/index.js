...
class AppStore extends Component {
  ...
  getFilteredAppsOnActiveTab = (filteredAppsList, activeTab) => {
    const filteredApps = filteredAppsList.filter(
  ...
  render() {
    ...
    const filteredAppsList = this.getFilteredApps(searchInput)
    const filteredAppsListOnActiveTab = this.getFilteredAppsOnActiveTab(
      filteredAppsList,
      activeTab,
    )
      ...
      <div className="bg-container">
        <div className="app-store-container">
          ...
          <ul className="apps-container">
            {filteredAppsListOnActiveTab.map(eachApp => (
